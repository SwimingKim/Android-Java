	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		b_insert.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if (dt_name.getText().toString().equals("")&&
						dt_id.getText().toString().equals("")&&
						dt_ko.getText().toString().equals("")&&
						dt_en.getText().toString().equals("")&&
					...
					values.put("num", Integer.valueOf(dt_id.getText().toString()));
